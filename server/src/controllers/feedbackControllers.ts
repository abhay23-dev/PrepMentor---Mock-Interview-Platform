...
export const getInterviewFeedback = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
...
return sendSuccess(res, feedbackResponse, "Feedback generated successfully");
})